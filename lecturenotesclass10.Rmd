...
Probability = (43/84)*100 = 52%

- What is the probability a randomly selected patient received the placebo
  and had a marked improvement?
Probability = (7/84)*100 = 8.3%
...
Very close to expected probabilities.
...
I think the absolute value between rolls being 4 has a higher probability because it has 4 possibilities (5,1 ; 6,2 ; 1,5 ; 2,6). The square of dice roll 1 being equal to dice roll 2 only has 3  possibilities (1,1 ; 1;1, 2,4).
...
It is more likely that the absolute value of the difference between dice roll 1 and dice roll 2 is equal to 4 than for the square of dice roll 1 to equal dice roll 2. 
